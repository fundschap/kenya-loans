      ...
      <div className="w-full bg-green-100 border-b border-green-300 py-2.5 px-4">
        <div className="container">
          <p className="text-xs sm:text-sm text-black flex items-start gap-2 leading-relaxed">
            ...
            <span>
              <strong>Important:</strong> We've been made aware of fraudulent websites impersonating M-KOPA. Be advised that this website is the only official M-KOPA website. For payments to M-KOPA Kenya use this website. Our official MPESA Number and support, call <strong>+254 705 282 786</strong>
            </span>
          </p>
        </div>
      </div>
